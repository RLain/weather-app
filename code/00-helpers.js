/**
 * API Icon code response mapping to the appropriate Icon Image
 * @param {*} icon The weather[0].icon code provided by Open Weather API
 * @returns Returns the correct Icon image related to the API response
 */
const setIcons = (icon) => {
  switch (icon) {
    case '01d':
